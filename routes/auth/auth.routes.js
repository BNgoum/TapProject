        ...
        routes(){
            ...
            */
            authRouter.get( '/', this.passport.authenticate('jwt', { session: false }), (req, res) => {
                ...
                if(req.user.isValidated) return sendApiSuccessResponse(res, Vocabulary.request.success, { _id: req.user._id, lastConnection: req.user.lastConnection, username: req.user.username })
